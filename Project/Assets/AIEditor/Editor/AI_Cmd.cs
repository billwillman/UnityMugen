...
public class AI_StateEvent_VelSet: AI_CreateStateEvent
{
	...
	protected override string GetDoStr()
	{
		string ret = string.Format ("trigger:VelSet(luaPlayer, {0}, {1})", VaildStr (velx), VaildStr (vely));
		return ret;
	}
}
...
public class AI_StateEvent_VelAdd: AI_CreateStateEvent
{
	...
	protected override string GetDoStr()
	{
		string ret = string.Format ("trigger:VelAdd(luaPlayer, {0}, {1})", VaildStr (velx), VaildStr (vely));
		return ret;
	}
}
...
public class AI_StateEvent_VelMul: AI_CreateStateEvent
{
	...
	protected override string GetDoStr()
	{
		string ret = string.Format ("trigger:VelMul(luaPlayer, {0}, {1})", VaildStr (velX), VaildStr (velY));
		return ret;
	}
}
