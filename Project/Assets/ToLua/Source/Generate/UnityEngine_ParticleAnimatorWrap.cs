...
public class UnityEngine_ParticleAnimatorWrap
{
	...
	static int get_doesAnimateColor(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index doesAnimateColor on a nil value");
		}
	}
	...
	static int get_worldRotationAxis(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index worldRotationAxis on a nil value");
		}
	}
	...
	static int get_localRotationAxis(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index localRotationAxis on a nil value");
		}
	}
	...
	static int get_sizeGrow(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index sizeGrow on a nil value");
		}
	}
	...
	static int get_rndForce(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index rndForce on a nil value");
		}
	}
	...
	static int get_colorAnimation(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index colorAnimation on a nil value");
		}
	}
