...
public class Mugen_CnsStateTypeWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("PlaySND", get_PlaySND, null);
		L.RegVar("VelSet", get_VelSet, null);
		L.RegVar("VelMul", get_VelMul, null);
		L.RegVar("HitDef", get_HitDef, null);
		L.RegVar("TargetState", get_TargetState, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_PlaySND(IntPtr L)
	{
		ToLua.Push(L, Mugen.CnsStateType.PlaySND);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_VelSet(IntPtr L)
	{
		ToLua.Push(L, Mugen.CnsStateType.VelSet);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_VelMul(IntPtr L)
	{
		ToLua.Push(L, Mugen.CnsStateType.VelMul);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_HitDef(IntPtr L)
	{
		ToLua.Push(L, Mugen.CnsStateType.HitDef);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_TargetState(IntPtr L)
	{
		ToLua.Push(L, Mugen.CnsStateType.TargetState);
		return 1;
	}
