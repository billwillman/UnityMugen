	...
	static int Play(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				...
				UnityEngine.Experimental.Director.Playable arg0 = (UnityEngine.Experimental.Director.Playable)ToLua.CheckObject<UnityEngine.Experimental.Director.Playable>(L, 2);
				obj.Play(arg0);
				return 0;
			}
			else if (count == 3)
